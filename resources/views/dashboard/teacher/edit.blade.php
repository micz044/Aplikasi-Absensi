...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      <h1 class="h2">Ubah Info Pegawai</h1>
    </div>      
    <div class="col-lg-8">
      <form method="post" action="/dashboard/teacher/{{ $teacher->id }}" class="mb-5">
            @method('put')
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="integer" class="form-control @error('nip') is-invalid @enderror" id="nip" name="nip" value="{{ old('nip', $teacher->nip) }}">
              @error('nip')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat" value="{{ old('alamat', $teacher->alamat) }}">
              @error('alamat')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
            ...
            <div class="mb-3">
              ...
              <input type="double" class="form-control @error('no_tlp') is-invalid @enderror" id="no_tlp" name="no_tlp" value="{{ old('no_tlp', $teacher->no_tlp) }}">
              @error('no_tlp')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
